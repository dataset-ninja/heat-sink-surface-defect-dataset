**Heat Sink Surface Defect Dataset** is a dataset for semantic segmentation and instance segmentation tasks. It is used in the industrial domain and surface defect detection research. 
